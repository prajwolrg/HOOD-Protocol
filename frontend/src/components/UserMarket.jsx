...
import { hexRates, hexToNumber, by18, toBigNumber, hexToExa } from "../helpers/hexToExa";
                                ...
                                <Form onSubmit={handleSubmit}>
                                    ...
                                    {txn && (
                                        <>
                                            ...
                                            &nbsp;
                                            &nbsp;
                                            <span>Amount to {txn}: {formatDecimal(hexToExa(depAmount))} {symbol.toUpperCase()} </span>
                                        </>
                                    )}
                                    <br />
                                </Form>
                                ...
                                <Form onSubmit={handleBorrowSubmit}>
                                    ...
                                    {txn && (
                                        <>
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <span>Amount to {txn}:  {formatDecimal(hexToExa(borrowAmount))}  {symbol.toUpperCase()}</span>
                                        </>
                                    )}
                                    <br />
                                </Form>
